        ...
        <div className="max-w-lg mx-auto space-y-2.5">
          ...
          {analysis && analysis.status === "failed" && (
            <Button
              ...
              onClick={() => setConfirmOpen(true)}
            >
              Analyse échouée — relancer (500 crédits)
            </Button>
          )}
        ...
        <DialogContent className="max-w-[340px] rounded-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <span className="block mt-2 font-medium text-foreground">
                Cette analyse utilise <strong>500 crédits</strong>
          ...
          <DialogFooter className="flex-row gap-2">
            ...
            <Button
              ...
              disabled={launching}
            >
              {launching ? <Loader2 className="w-4 h-4 animate-spin" /> : "Lancer (500 crédits)"}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
