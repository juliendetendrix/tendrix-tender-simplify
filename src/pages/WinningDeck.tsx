              ...
              <Card className="border-l-4 border-l-primary shadow-medium">
                <CardHeader className="text-center pb-6">
                  <CardTitle className="text-2xl font-bold gradient-text mb-4">
                    Tendrix Winning Deck verrouillé
                  </CardTitle>
                </CardHeader>
                <CardContent className="text-center space-y-6">
                  <div className="space-y-4">
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed">
                      L'élaboration de votre Tendrix Winning Deck est pour le moment indisponible
                    </p>
                  </div>
                  ...
                  <div className="text-sm text-muted-foreground bg-muted/30 p-4 rounded-lg">
                    <p>
                      Nos équipes vous accompagneront dans l'élaboration de votre Winning Deck personnalisé 
                      pour maximiser vos chances de remporter des appels d'offres.
                    </p>
                  </div>
                </CardContent>
              </Card>
