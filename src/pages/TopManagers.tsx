              ...
              <Card className="border-l-4 border-l-primary shadow-medium">
                <CardHeader className="text-center pb-6">
                  <CardTitle className="text-2xl font-bold gradient-text mb-4">
                    Top Chargés d'affaires verrouillé
                  </CardTitle>
                </CardHeader>
                <CardContent className="text-center space-y-6">
                  <div className="space-y-4">
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed">
                      Le classement des top chargés d'affaires est pour le moment indisponible
                    </p>
                  </div>
                  ...
                  <div className="text-sm text-muted-foreground bg-muted/30 p-4 rounded-lg">
                    <p>
                      Nos équipes vous présenteront le classement des meilleurs chargés d'affaires 
                      et vous aideront à choisir celui qui correspond le mieux à vos besoins.
                    </p>
                  </div>
                </CardContent>
              </Card>
